...
**现阶段性能基准测试结果**：在与100% 随机写入、4KB Payload、强一致性落盘、单put场景下，**TitanKV 的吞吐量约 4.4k IOPS，是 RocksDB数据库引擎 的 4.186 倍**，详情见docs/titanvsrocsdb.md。
...
## 后续目标
1、目前只支持SPSC架构，后续会继续完成MPSC架构开发。

2、代码仍有很大的优化空间，后续会继续优化IO性能。
